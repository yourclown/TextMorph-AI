      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-cyan-200/80 font-mono mb-8">
            Transform your ideas into captivating 100-word masterpieces in seconds
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          <div className="p-6 bg-black/30 backdrop-blur-lg rounded-xl border border-cyan-400/20 hover:border-cyan-400/40 transition-all">
            ...
            <h3 className="text-xl font-bold text-cyan-400 mb-2">Instant Generation</h3>
            <p className="text-cyan-200/80 font-mono text-sm">
              Create unique stories in under 10 seconds using our advanced AI engine
            </p>
          </div>
          ...
          <div className="p-6 bg-black/30 backdrop-blur-lg rounded-xl border border-blue-400/20 hover:border-blue-400/40 transition-all">
            ...
            <h3 className="text-xl font-bold text-blue-400 mb-2">Multiple Genres</h3>
            <p className="text-cyan-200/80 font-mono text-sm">
              Choose from Horror, Romance, Sci-Fi, and more. Your imagination's the limit
            </p>
          </div>
          ...
          <div className="p-6 bg-black/30 backdrop-blur-lg rounded-xl border border-purple-400/20 hover:border-purple-400/40 transition-all">
            ...
            <h3 className="text-xl font-bold text-purple-400 mb-2">Secure Archive</h3>
            <p className="text-cyan-200/80 font-mono text-sm">
        ...
        <div className="mb-20 p-8 bg-black/30 backdrop-blur-lg rounded-2xl border border-cyan-400/20">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="flex-1">
              <h2 className="text-3xl font-bold text-cyan-400 mb-4">See it in Action</h2>
              <div className="font-mono text-cyan-200/80 mb-6">
                <span className="text-cyan-400">$</span> generate-story --genre sci-fi --theme "space adventure"
              </div>
              <div className="p-4 bg-black/50 rounded-lg border border-cyan-400/10">
                <p className="text-cyan-300 text-sm animate-pulse">Generating story about interstellar explorers...</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Pricing Section */}
        <div className="text-center mb-20">
          <h2 className="text-4xl font-bold text-cyan-400 mb-2">Unlimited Creativity</h2>
          <p className="text-cyan-200/80 font-mono mb-8">
            Just $1 for 3 story credits - Less than a coffee for endless inspiration
          </p>
          <div className="inline-block p-1 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl animate-gradient-x">
            <div className="bg-gray-900 rounded-lg p-8">
              ...
              <div className="text-cyan-200/80 font-mono mb-6">3 Story Credits</div>
              <Link
                to="/register"
        ...
        <div className="border-t border-cyan-400/20 pt-8 text-center">
          <div className="flex justify-center space-x-6 mb-4">
            <Link to="/terms" className="text-cyan-400/80 hover:text-cyan-300 text-sm font-mono">Terms</Link>
            <Link to="/privacy" className="text-cyan-400/80 hover:text-cyan-300 text-sm font-mono">Privacy</Link>
            <Link to="/contact" className="text-cyan-400/80 hover:text-cyan-300 text-sm font-mono">Contact</Link>
          </div>
          <p className="text-cyan-400/50 text-sm font-mono">
            © {new Date().getFullYear()} StoryForge AI. Powered by neural magic.
          </p>
        </div>
      </div>
    </div>
